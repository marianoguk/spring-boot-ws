package org.coding.springboot.ws.countrysoap.infraestructura.config;
...
import org.coding.springboot.ws.countrysoap.domain.service.Mapper;
...
public class CountryWsConfig {
    ...
    @Bean
    public CountryService countryService(CountryRepository repository, Mapper mapper) {
